...
\resumeProjectHeading{\href{https://github.com/geon-youn/blog-api}{\underline{\textbf{RESTful Blog API}}} $|$ \emph{NodeJS, ExpressJS, JWT, MongoDB}}{}
\resumeItemListStart
\resumeItem{Created a RESTful API for blogs supporting CRUD operations for blog users, comments, and blog posts}
\resumeItem{Added documentation for all routes specifying how to use them}
\resumeItem{Supported user authentication through implementing JSON web tokens}
\resumeItemListEnd
